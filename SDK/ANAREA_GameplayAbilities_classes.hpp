...
public:
	...
	unsigned char                                      UnknownData01[0x1A0];                                     // 0x0150(0x01A0) MISSED OFFSET
	...
	unsigned char                                      UserAbilityActivationInhibited;                           // 0x0398(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      ReplicationProxyEnabled;                                  // 0x0399(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bSuppressGrantAbility;                                    // 0x039A(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bSuppressGameplayCues;                                    // 0x039B(0x0001) (ZeroConstructor, IsPlainOldData)
	TArray<class AGameplayAbilityTargetActor*>         SpawnedTargetActors;                                      // 0x03A0(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData04[0x28];                                      // 0x03B0(0x0028) MISSED OFFSET
	class AActor*                                      OwnerActor;                                               // 0x03D8(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	class AActor*                                      AvatarActor;                                              // 0x03E0(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x10];                                      // 0x03E8(0x0010) MISSED OFFSET
	struct FGameplayAbilitySpecContainer               ActivatableAbilities;                                     // 0x03F8(0x0120) (BlueprintVisible, BlueprintReadOnly, Net)
	unsigned char                                      UnknownData06[0x30];                                      // 0x0518(0x0030) MISSED OFFSET
	TArray<class UGameplayAbility*>                    AllReplicatedInstancedAbilities;                          // 0x0548(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData07[0x1D0];                                     // 0x0558(0x01D0) MISSED OFFSET
	struct FGameplayAbilityRepAnimMontage              RepAnimMontageInfo;                                       // 0x0728(0x0030) (Net)
	unsigned char                                      bCachedIsNetSimulated;                                    // 0x0758(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bPendingMontageRep;                                       // 0x0759(0x0001) (ZeroConstructor, IsPlainOldData)
	struct FGameplayAbilityLocalAnimMontage            LocalAnimMontageInfo;                                     // 0x0760(0x0030)
	unsigned char                                      UnknownData08[0xA0];                                      // 0x0790(0x00A0) MISSED OFFSET
	struct FActiveGameplayEffectsContainer             ActiveGameplayEffects;                                    // 0x0830(0x0480) (Net)
	struct FActiveGameplayCueContainer                 ActiveGameplayCues;                                       // 0x0CB0(0x0128) (Net)
	struct FActiveGameplayCueContainer                 MinimalReplicationGameplayCues;                           // 0x0DD8(0x0128) (Net)
	unsigned char                                      UnknownData09[0x128];                                     // 0x0F00(0x0128) MISSED OFFSET
	TArray<unsigned char>                              BlockedAbilityBindings;                                   // 0x1028(0x0010) (Net, ZeroConstructor, Transient)
	unsigned char                                      UnknownData10[0x128];                                     // 0x1038(0x0128) MISSED OFFSET
	struct FMinimalReplicationTagCountMap              MinimalReplicationTags;                                   // 0x1160(0x0060) (Net)
	unsigned char                                      UnknownData11[0x10];                                      // 0x11C0(0x0010) MISSED OFFSET
	struct FReplicatedPredictionKeyMap                 ReplicatedPredictionKeyMap;                               // 0x11D0(0x0118) (Net)
...
public:
	...
	unsigned char                                      bAllowGameplayModEvaluationChannels;                      // 0x00E0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	...
	unsigned char                                      PredictTargetGameplayEffects;                             // 0x0210(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	class UGameplayCueManager*                         GlobalGameplayCueManager;                                 // 0x0218(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x40];                                      // 0x0220(0x0040) MISSED OFFSET
...
public:
	...
	class UAbilitySystemComponent*                     AbilitySystemComponent;                                   // 0x02B8(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	struct FScriptMulticastDelegate                    OnFinish;                                                 // 0x00B8(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	...
	unsigned char                                      bIsAdditive;                                              // 0x00DC(0x0001) (Net, ZeroConstructor, IsPlainOldData)
...
public:
	struct FScriptMulticastDelegate                    OnFinish;                                                 // 0x00B8(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x00B8(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    OnLanded;                                                 // 0x00C8(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0xF];                                       // 0x00C8(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	...
	unsigned char                                      bFinishOnLanded;                                          // 0x00F4(0x0001) (Net, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FScriptMulticastDelegate                    OnFinished;                                               // 0x00B8(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x00B8(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	...
	unsigned char                                      bDisableDestinationReachedInterrupt;                      // 0x0104(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bSetNewMovementMode;                                      // 0x0105(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EMovementMode>                         NewMovementMode;                                          // 0x0106(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bRestrictSpeedToExpected;                                 // 0x0107(0x0001) (Net, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FScriptMulticastDelegate                    OnTimedOut;                                               // 0x00B8(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x00B8(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    OnTimedOutAndDestinationReached;                          // 0x00C8(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0xF];                                       // 0x00C8(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	...
	unsigned char                                      bSetNewMovementMode;                                      // 0x00F4(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EMovementMode>                         NewMovementMode;                                          // 0x00F5(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bRestrictSpeedToExpected;                                 // 0x00F6(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	class UCurveVector*                                PathOffsetCurve;                                          // 0x00F8(0x0008) (Net, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bIsPush;                                                  // 0x00EC(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bIsAdditive;                                              // 0x00ED(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bNoZForce;                                                // 0x00EE(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bUseFixedWorldDirection;                                  // 0x0100(0x0001) (Net, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FScriptMulticastDelegate                    OnTargetLocationReached;                                  // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
{
public:
	struct FScriptMulticastDelegate                    OnSync;                                                   // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
{
public:
	struct FScriptMulticastDelegate                    OnCompleted;                                              // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    OnBlendOut;                                               // 0x0090(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0xF];                                       // 0x0090(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    OnInterrupted;                                            // 0x00A0(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData02[0xF];                                       // 0x00A0(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    OnCancelled;                                              // 0x00B0(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData03[0xF];                                       // 0x00B0(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	...
	unsigned char                                      bStopWhenAbilityEnds;                                     // 0x0100(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FScriptMulticastDelegate                    OnPerformAction;                                          // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    OnFinished;                                               // 0x0090(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0xF];                                       // 0x0090(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
{
public:
	struct FScriptMulticastDelegate                    Success;                                                  // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    DidNotSpawn;                                              // 0x0090(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0xF];                                       // 0x0090(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
{
public:
	struct FScriptMulticastDelegate                    OnStateEnded;                                             // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    OnStateInterrupted;                                       // 0x0090(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0xF];                                       // 0x0090(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	unsigned char                                      UnknownData02[0x18];                                      // 0x00A0(0x0018) MISSED OFFSET
...
{
public:
	struct FScriptMulticastDelegate                    TimeElapsed;                                              // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
{
public:
	struct FScriptMulticastDelegate                    OnActivate;                                               // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
{
public:
	struct FScriptMulticastDelegate                    OnCommit;                                                 // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
{
public:
	struct FScriptMulticastDelegate                    OnChange;                                                 // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
{
public:
	struct FScriptMulticastDelegate                    OnCancel;                                                 // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	unsigned char                                      UnknownData01[0x8];                                       // 0x0090(0x0008) MISSED OFFSET
...
{
public:
	struct FScriptMulticastDelegate                    OnConfirm;                                                // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
public:
	struct FScriptMulticastDelegate                    OnConfirm;                                                // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    OnCancel;                                                 // 0x0090(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0xF];                                       // 0x0090(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
{
public:
	struct FScriptMulticastDelegate                    OnFinish;                                                 // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	unsigned char                                      UnknownData01[0x8];                                       // 0x0090(0x0008) MISSED OFFSET
...
{
public:
	struct FScriptMulticastDelegate                    OnApplied;                                                // 0x01B8(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x01B8(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
{
public:
	struct FScriptMulticastDelegate                    bLocked;                                                  // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
{
public:
	struct FScriptMulticastDelegate                    OnRemoved;                                                // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    InvalidHandle;                                            // 0x0090(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0xF];                                       // 0x0090(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
{
public:
	struct FScriptMulticastDelegate                    EventReceived;                                            // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	unsigned char                                      UnknownData01[0x8];                                       // 0x0090(0x0008) MISSED OFFSET
...
{
public:
	struct FScriptMulticastDelegate                    Added;                                                    // 0x00A8(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x00A8(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
{
public:
	struct FScriptMulticastDelegate                    Removed;                                                  // 0x00A8(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x00A8(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
{
public:
	struct FScriptMulticastDelegate                    OnPress;                                                  // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	unsigned char                                      UnknownData01[0x10];                                      // 0x0090(0x0010) MISSED OFFSET
...
{
public:
	struct FScriptMulticastDelegate                    OnRelease;                                                // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	unsigned char                                      UnknownData01[0x10];                                      // 0x0090(0x0010) MISSED OFFSET
...
{
public:
	struct FScriptMulticastDelegate                    OnOverlap;                                                // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
{
public:
	struct FScriptMulticastDelegate                    ValidData;                                                // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    Cancelled;                                                // 0x0090(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0xF];                                       // 0x0090(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
{
public:
	struct FScriptMulticastDelegate                    OnVelocityChage;                                          // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
public:
	...
	unsigned char                                      bReplicateInputDirectly;                                  // 0x00C8(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      RemoteInstanceEnded;                                      // 0x00C9(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bServerRespectsRemoteAbilityCancellation;                 // 0x00D0(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      bRetriggerInstancedAbility;                               // 0x00D1(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	struct FGameplayTagQuery                           CancelAbilitiesMatchingTagQuery;                          // 0x01D0(0x0048) (Edit, DisableEditOnInstance)
	struct FGameplayTagContainer                       CancelAbilitiesWithTag;                                   // 0x0218(0x0020) (Edit, DisableEditOnInstance)
	struct FGameplayTagContainer                       BlockAbilitiesWithTag;                                    // 0x0238(0x0020) (Edit, DisableEditOnInstance)
	struct FGameplayTagContainer                       ActivationOwnedTags;                                      // 0x0258(0x0020) (Edit, DisableEditOnInstance)
	struct FGameplayTagContainer                       ActivationRequiredTags;                                   // 0x0278(0x0020) (Edit, DisableEditOnInstance)
	struct FGameplayTagContainer                       ActivationBlockedTags;                                    // 0x0298(0x0020) (Edit, DisableEditOnInstance)
	struct FGameplayTagContainer                       SourceRequiredTags;                                       // 0x02B8(0x0020) (Edit, DisableEditOnInstance)
	struct FGameplayTagContainer                       SourceBlockedTags;                                        // 0x02D8(0x0020) (Edit, DisableEditOnInstance)
	struct FGameplayTagContainer                       TargetRequiredTags;                                       // 0x02F8(0x0020) (Edit, DisableEditOnInstance)
	struct FGameplayTagContainer                       TargetBlockedTags;                                        // 0x0318(0x0020) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData01[0x20];                                      // 0x0338(0x0020) MISSED OFFSET
	TArray<class UGameplayTask*>                       ActiveTasks;                                              // 0x0358(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x10];                                      // 0x0368(0x0010) MISSED OFFSET
	class UAnimMontage*                                CurrentMontage;                                           // 0x0378(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x60];                                      // 0x0380(0x0060) MISSED OFFSET
	unsigned char                                      bIsActive;                                                // 0x03E0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bIsCancelable;                                            // 0x03E1(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bIsBlockingOtherAbilities;                                // 0x03E2(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x15];                                      // 0x03E3(0x0015) MISSED OFFSET
	unsigned char                                      bMarkPendingKillOnAbilityEnd;                             // 0x03F8(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UAnimMontage*                                MontageToPlay;                                            // 0x0400(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              PlayRate;                                                 // 0x0408(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FName                                       SectionName;                                              // 0x040C(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TArray<class UClass*>                              GameplayEffectClassesWhileAnimating;                      // 0x0418(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	TArray<class UGameplayEffect*>                     GameplayEffectsWhileAnimating;                            // 0x0428(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance, EditConst)
...
{
public:
	unsigned char                                      ShouldProduceTargetDataOnServer;                          // 0x0218(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FGameplayAbilityTargetingLocationInfo       StartLocation;                                            // 0x0220(0x0070) (BlueprintVisible, BlueprintReadOnly, Net)
	unsigned char                                      UnknownData00[0x30];                                      // 0x0290(0x0030) MISSED OFFSET
	class APlayerController*                           MasterPC;                                                 // 0x02C0(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UGameplayAbility*                            OwningAbility;                                            // 0x02C8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDestroyOnConfirmation;                                   // 0x02D0(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	class AActor*                                      SourceActor;                                              // 0x02D8(0x0008) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	struct FWorldReticleParameters                     ReticleParams;                                            // 0x02E0(0x000C) (BlueprintVisible)
	class UClass*                                      ReticleClass;                                             // 0x02F0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FGameplayTargetDataFilterHandle             Filter;                                                   // 0x02F8(0x0010) (BlueprintVisible, Net)
	unsigned char                                      bDebug;                                                   // 0x0308(0x0001) (Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x17];                                      // 0x0309(0x0017) MISSED OFFSET
	class UAbilitySystemComponent*                     GenericDelegateBoundASC;                                  // 0x0320(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
public:
	...
	unsigned char                                      bTraceAffectsAimPitch;                                    // 0x0334(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	float                                              CollisionRadius;                                          // 0x0340(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CollisionHeight;                                          // 0x0344(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UClass*                                      PlacedActorClass;                                         // 0x0360(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          PlacedActorMaterial;                                      // 0x0368(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FWorldReticleParameters                     Parameters;                                               // 0x0218(0x000C) (Edit, BlueprintVisible, DisableEditOnTemplate)
	unsigned char                                      bFaceOwnerFlat;                                           // 0x0224(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bSnapToTargetedActor;                                     // 0x0225(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bIsTargetValid;                                           // 0x0226(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bIsTargetAnActor;                                         // 0x0227(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class APlayerController*                           MasterPC;                                                 // 0x0228(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class AActor*                                      TargetingActor;                                           // 0x0230(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UCapsuleComponent*                           CollisionComponent;                                       // 0x0238(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TArray<class UActorComponent*>                     VisualizationComponents;                                  // 0x0240(0x0010) (ExportObject, ZeroConstructor)
...
{
public:
	unsigned char                                      bAutoDestroyOnRemove;                                     // 0x0218(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              AutoDestroyDelay;                                         // 0x021C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      WarnIfTimelineIsStillRunning;                             // 0x0220(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      WarnIfLatentActionIsStillRunning;                         // 0x0221(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FGameplayTag                                GameplayCueTag;                                           // 0x0224(0x0008) (Edit, DisableEditOnInstance)
	struct FGameplayTagReferenceHelper                 ReferenceHelper;                                          // 0x0230(0x0010) (Edit)
	struct FName                                       GameplayCueName;                                          // 0x0240(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bAutoAttachToOwner;                                       // 0x0248(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      IsOverride;                                               // 0x0249(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      bUniqueInstancePerInstigator;                             // 0x024A(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      bUniqueInstancePerSourceObject;                           // 0x024B(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      bAllowMultipleOnActiveEvents;                             // 0x024C(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      bAllowMultipleWhileActiveEvents;                          // 0x024D(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                NumPreallocatedInstances;                                 // 0x0250(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x34];                                      // 0x0254(0x0034) MISSED OFFSET
...
public:
	...
	unsigned char                                      IsOverride;                                               // 0x0048(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	unsigned char                                      bExecutePeriodicEffectOnApplication;                      // 0x01E8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EGameplayEffectPeriodInhibitionRemovedPolicy       PeriodicInhibitionPolicy;                                 // 0x01E9(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	unsigned char                                      bDenyOverflowApplication;                                 // 0x0270(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      bClearStackOnOverflow;                                    // 0x0271(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	unsigned char                                      bRequireModifierSuccessToTriggerCues;                     // 0x0298(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      bSuppressStackingCues;                                    // 0x0299(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	struct FGameplayTagRequirements                    RemovalTagRequirements;                                   // 0x03F8(0x0040) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FInheritedTagContainer                      RemoveGameplayEffectsWithTags;                            // 0x0438(0x0060) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FGameplayTagRequirements                    GrantedApplicationImmunityTags;                           // 0x0498(0x0040) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FGameplayEffectQuery                        GrantedApplicationImmunityQuery;                          // 0x04D8(0x0138) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0610(0x0008) MISSED OFFSET
	struct FGameplayEffectQuery                        RemoveGameplayEffectQuery;                                // 0x0618(0x0138) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	EGameplayEffectStackingType                        StackingType;                                             // 0x0751(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                StackLimitCount;                                          // 0x0754(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EGameplayEffectStackingDurationPolicy              StackDurationRefreshPolicy;                               // 0x0758(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EGameplayEffectStackingPeriodPolicy                StackPeriodResetPolicy;                                   // 0x0759(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EGameplayEffectStackingExpirationPolicy            StackExpirationPolicy;                                    // 0x075A(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TArray<struct FGameplayAbilitySpecDef>             GrantedAbilities;                                         // 0x0760(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
...
{
public:
	unsigned char                                      bRequiresPassedInTags;                                    // 0x0038(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
{
public:
	unsigned char                                      bAllowNonNetAuthorityDependencyRegistration;              // 0x0038(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
