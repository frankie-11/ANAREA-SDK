...
public:
	...
	EMagicLeapIdentityError RequestAttributeValueAsync(TArray<EMagicLeapIdentityKey>* RequestedAttributeList, struct FScriptDelegate* ResultDelegate);
	...
	void GetAllAvailableAttributesAsync(struct FScriptDelegate* ResultDelegate);
