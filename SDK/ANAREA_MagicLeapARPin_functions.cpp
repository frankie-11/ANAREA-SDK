...
EMagicLeapPassableWorldError UMagicLeapARPinFunctionLibrary::STATIC_GetClosestARPin(struct FVector* SearchPoint, struct FGuid* PinID)
{
...
bool UMagicLeapARPinFunctionLibrary::STATIC_GetARPinPositionAndOrientation(struct FGuid* PinID, struct FVector* Position, struct FRotator* Orientation, bool* PinFoundInEnvironment)
{
