...
void UXRLoadingScreenFunctionLibrary::STATIC_SetLoadingScreen(class UTexture** Texture, struct FVector2D* Scale, struct FVector* Offset, bool* bShowLoadingMovie, bool* bShowOnSet)
{
...
void UXRLoadingScreenFunctionLibrary::STATIC_AddLoadingScreenSplash(class UTexture** Texture, struct FVector* Translation, struct FRotator* Rotation, struct FVector2D* Size, struct FRotator* DeltaRotation, bool* bClearBeforeAdd)
{
