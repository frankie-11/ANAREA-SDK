...
// WidgetBlueprintGeneratedClass WBP_MenuBtn_TextAndBackground.WBP_MenuBtn_TextAndBackground_C
// 0x0038 (0x02B8 - 0x0280)
class UWBP_MenuBtn_TextAndBackground_C : public UWBP_BaseBtn_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WBP_MenuBtn_TextAndBackground.WBP_MenuBtn_TextAndBackground_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WBP_MenuBtn_TextAndBackground(int* EntryPoint);
};
