...
void UPlayFabAuthenticationContext::SetPlayFabId(struct FString* InKey)
{
...
void UPlayFabAuthenticationContext::SetEntityToken(struct FString* InToken)
{
...
void UPlayFabAuthenticationContext::SetDeveloperSecretKey(struct FString* InKey)
{
...
void UPlayFabAuthenticationContext::SetClientSessionTicket(struct FString* InTicket)
{
