...
public:
	...
	void SetPlayFabId(struct FString* InKey);
	void SetEntityToken(struct FString* InToken);
	void SetDeveloperSecretKey(struct FString* InKey);
	void SetClientSessionTicket(struct FString* InTicket);
