...
// WidgetBlueprintGeneratedClass WBP_MenuInventory_CharacterModels.WBP_MenuInventory_CharacterModels_C
// 0x0088 (0x02B8 - 0x0230)
class UWBP_MenuInventory_CharacterModels_C : public UUserWidget
{
public:
	...
	struct FScriptMulticastDelegate                    OnChangeCharacterModelPreviewRequested;                   // 0x02A0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WBP_MenuInventory_CharacterModels.WBP_MenuInventory_CharacterModels_C");
		return ptr;
	}
	...
	void InitSelection();
	void ExecuteUbergraph_WBP_MenuInventory_CharacterModels(int* EntryPoint);
	void OnChangeCharacterModelPreviewRequested__DelegateSignature(struct FName* backpackName);
