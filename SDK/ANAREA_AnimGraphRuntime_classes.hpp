...
public:
	...
	float STATIC_K2_EndProfilingTimer(bool* bLog, struct FString* LogPrefix);
	...
	float STATIC_K2_CalculateVelocityFromPositionHistory(float* DeltaSeconds, struct FVector* Position, int* NumberOfSamples, float* VelocityMin, float* VelocityMax, struct FPositionHistory* History);
};
